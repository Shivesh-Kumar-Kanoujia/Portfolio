  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      const res = await fetch('https://api.web3forms.com/submit', {
        ...
        body: JSON.stringify({
          access_key: '1da1d181-64ce-4a08-be57-6eb7cba33b3a',
          ...formData,
        }),
      });
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-24">
          ...
          <div>
            ...
            <div className="flex flex-col gap-6">
              <a href="mailto:shiveshkanoujia@gmail.com" className="flex items-center gap-4 text-secondary hover:text-text transition-colors group w-max">
                ...
                <span className="text-lg font-medium">shiveshkanoujia@gmail.com</span>
              </a>
              <a href="https://github.com/Shivesh-Kumar-Kanoujia" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 text-secondary hover:text-text transition-colors group w-max">
                <div className="w-12 h-12 flex items-center justify-center rounded-2xl bg-surface border border-gray-100 shadow-sm group-hover:border-primary/30 group-hover:bg-primary/5 group-hover:text-primary transition-all duration-300">
              ...
              <a href="https://www.linkedin.com/in/shivesh-kanoujia-198824390" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 text-secondary hover:text-text transition-colors group w-max">
                <div className="w-12 h-12 flex items-center justify-center rounded-2xl bg-surface border border-gray-100 shadow-sm group-hover:border-primary/30 group-hover:bg-primary/5 group-hover:text-primary transition-all duration-300">
          ...
          <div className="bg-surface border border-gray-100 shadow-[0_8px_30px_rgba(0,0,0,0.04)] rounded-3xl p-8 lg:p-10">
            <form className="flex flex-col gap-6" onSubmit={handleSubmit}>
              <input type="hidden" name="access_key" value="1da1d181-64ce-4a08-be57-6eb7cba33b3a" />
              ...
              <button 
                type="submit" 
                disabled={submitting}
                className="w-full bg-text text-white font-medium py-4 rounded-xl hover:bg-text/90 shadow-[0_4px_14px_0_rgb(17,24,39,0.39)] hover:shadow-[0_6px_20px_rgba(17,24,39,0.23)] hover:-translate-y-0.5 transition-all duration-300 flex items-center justify-center gap-2 group mt-2 disabled:opacity-60 disabled:cursor-not-allowed disabled:hover:translate-y-0"
              >
                {submitting ? (
                  'Sending...'
                ) : (
